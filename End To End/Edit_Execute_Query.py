...
plexos_path = 'C:/Program Files (x86)/Energy Exemplar/PLEXOS 8.0/'
...
def main():
    run_model('C:\Program Files (x86)\Energy Exemplar\PLEXOS 8.0', 'rts2.xml', '.', 'Base')
...
sol = Solution()
sol_file = 'Model Base Solution\Model Base Solution.zip' # replace with your solution file
csv_file = 'Gens.csv'
print 'line 24'
